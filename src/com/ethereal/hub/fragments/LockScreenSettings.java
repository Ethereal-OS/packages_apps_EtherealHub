...
import com.android.internal.util.ethereal.udfps.UdfpsUtils;
...
import com.ethereal.hub.preferences.SecureSettingListPreference;
...
public class LockScreenSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.etherealhub_lockscreen);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.etherealhub_lockscreen;
                    result.add(sir);
                    return result;
                }
